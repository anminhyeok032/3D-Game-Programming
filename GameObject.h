...
public:
	...
	int							CTankBot_heatNum = 0;


	CGameObject*				m_pObjectCollided = NULL;
	DWORD						m_dwDefaultColor = RGB(255, 255, 255);
...
public:
	...
	void Rotate1(float fPitch, float fYaw, float fRoll);//-
...
public:
	...
	void SetRotationAxis(XMFLOAT3& xmf3RotationAxis, XMFLOAT3& xmf3Offset) {
...
public:
	...
	float						m_fBulletEffectiveRange = 150.0f;	//- 추적의 최대 길이를 늘려서 추적 시간을 늘림

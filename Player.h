...
public:
	...
	void RotateBot(float fPitch = 0.0f, float fYaw = 0.0f, float fRoll = 0.0f);
...
public:
	...
	void RotateGunByMouse(float fAngle) { m_pGun->Rotate1(fAngle, 0.0f, 0.0f); } // ---
...
public:
	...
	BoundingOrientedBox			m_xmOOBB_Bot = BoundingOrientedBox();
